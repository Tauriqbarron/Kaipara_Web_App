<nav class="navbar navbar-expand-lg navbar-light bg-light d-flex shadow">
    ...
    <a href="{{route('admin.login')}}" class="btn btn-primary  mx-1 align-self-start shadow">Admin</a>
    <a href="{{ url('/selectuser') }}" class="btn btn-primary  mx-1 align-self-start shadow">Login</a>
    <a href="{{ url('/registration') }}" class="btn btn-primary  mx-1 align-self-start shadow">Sign up</a>
</nav>
