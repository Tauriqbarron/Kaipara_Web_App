<div  class="jumbotron bg-light shadow-sm rounded p-2 mt-2 float-none">
    <h6>Jump to:</h6>
    ...
    <a href="#timetable" onclick="pageToggle('rosterBtn','rosterContainer')"  class="nav-link"><h6>Timetable</h6></a>
    <a href="#settings" onclick="pageToggle('settingsBtn','settingsContainer')"  class="nav-link"><h6>Your Information</h6></a>
</div>
